...
typedef NS_ENUM(NSInteger, GBDeviceModel) {
    ...
    GBDeviceModeliPadPro13Inch,
    GBDeviceModeliPadPro11Inch8,
...
typedef NS_ENUM(NSInteger, GBDeviceDisplay) {
    ...
    GBDeviceDisplay6p3Inch,   // iPhone 17 Pro / 17
    GBDeviceDisplay6p9Inch,   // iPhone 17 Pro Max
    GBDeviceDisplay13Inch     // 2024+ iPad Pro/Air 13″
};
